...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cslabcoin-project/cslabcoin>";
    const std::string URL_WEBSITE = "<https://cslabcoin.org>";
