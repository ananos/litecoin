...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1515863599, 3434091, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x913d30e01a4bfa7b0c6386e1a57bcd9e12b817be4bf83c47bbf93abee825b89a"));
        ...
        vSeeds.emplace_back("cslabcoin.nanosnet.com", true);
        vSeeds.emplace_back("cslabcoin.org", true);
        vSeeds.emplace_back("nanosnet.com", true);
        vSeeds.emplace_back("ananos.co.uk", true);
        vSeeds.emplace_back("ananos.uk", false);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cslabcointools.com", true);
        vSeeds.emplace_back("seed-b.cslabcoin.loshan.co.uk", true);
