...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.cslabcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.cslabcointools.com", true);
        vSeeds.emplace_back("dnsseed.cslabcoinpool.org", true);
