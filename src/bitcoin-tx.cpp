...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cslabcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cslabcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cslabcoin transaction") + "\n" +
              "  cslabcoin-tx [options] -create [commands]   " + _("Create hex-encoded cslabcoin transaction") + "\n" +
              "\n";
